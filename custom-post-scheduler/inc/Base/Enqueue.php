...
class Enqueue extends BaseController
{
	...
	{
		wp_enqueue_style('mrdipeshcpsstyle', $this->plugin_url . 'assets/mrdipeshcpsstyle-admin.css');
		wp_enqueue_script('mrdipeshcpsscript', $this->plugin_url . 'assets/mrdipeshcpsscript-admin.js');
	}
	function wpEnqueue()
	{
